...
export default function EditorPage({ params }: Props) {
  ...
  return (
    <div className="flex flex-col h-screen w-screen overflow-hidden">
      <EditorTopBar diagram={diagram} saveStatus={saveStatus} onBack={() => router.push('/')} />
      <div className="flex flex-1 min-h-0 overflow-hidden">
        <div className="w-[35%] h-full border-r border-zinc-800 shrink-0">
          <VoicePanel isLoading={isLoading} onSilence={handleSilence} onMockSubmit={handleSilence} />
        </div>
