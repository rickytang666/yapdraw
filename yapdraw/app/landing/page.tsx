...
export const metadata = {
  title: 'YapDraw | Architecture at the speed of thought',
  description: 'Create architecture diagrams by describing them out loud. Built for developers and teams.',
}

export default function LandingPage() {
  return (
    <div className="min-h-screen text-slate-900 antialiased bg-[#fbfcfd] overflow-auto" style={{
      ...
      <nav className="flex items-center px-8 py-6 max-w-7xl mx-auto">
        <div className="flex items-center gap-2">
          <Image
            ...
            className="rounded"
          />
          <span className="font-bold text-xl tracking-tight uppercase">YapDraw</span>
        </div>
      </nav>
      ...
      <section className="bg-white border-y border-slate-200 py-32">
        <div className="max-w-7xl mx-auto px-8">
          <div className="mb-20">
            <h2 className="text-xs font-mono font-bold uppercase tracking-widest text-slate-400 mb-4">Process / Workflow</h2>
            <p className="text-4xl font-bold tracking-tight">Built for technical architects.</p>
          </div>
          ...
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            ...
            <div className="relative border-2 border-[#1e1e1e] shadow-[4px_4px_0px_#1e1e1e] rounded-sm bg-white p-2 overflow-hidden sticky top-8">
              ...
              <div className="w-full h-64 bg-gradient-to-br from-slate-50 to-slate-100 border-b border-slate-100 mb-4 flex items-center justify-center">
                <span className="text-slate-300 text-sm font-mono">[ Diagram Preview ]</span>
              </div>
            ...
            <div className="bg-white border border-slate-200 p-10 rounded-xl relative group hover:border-[#6965db] hover:translate-y-[-4px] transition-all duration-300">
              <span className="absolute top-6 right-8 text-6xl font-black text-slate-100 group-hover:text-slate-200 transition-colors">01</span>
              <h3 className="text-xl font-bold mb-4">Speak Naturally</h3>
              <p className="text-slate-500 leading-relaxed mb-6">Explain your microservices, databases, and message queues just like you&apos;re talking to a senior engineer.</p>
              <div className="text-slate-400 italic font-[family-name:var(--font-hand)]">
                &quot;First, we have a React frontend hitting a Gateway...&quot;
              </div>
            </div>
            ...
            <div className="bg-white border border-[#6965db]/20 p-10 rounded-xl relative group hover:border-[#6965db] hover:translate-y-[-4px] transition-all duration-300">
              <span className="absolute top-6 right-8 text-6xl font-black text-slate-100 group-hover:text-slate-200 transition-colors">02</span>
              <h3 className="text-xl font-bold mb-4">Real-time Rendering</h3>
              <p className="text-slate-500 leading-relaxed mb-6">Our engine translates intent into Excalidraw primitives. Nodes connect and labels appear as you speak.</p>
            ...
            {/* Step 3 */}
            <div className="bg-white border border-slate-200 p-10 rounded-xl relative group hover:border-[#6965db] hover:translate-y-[-4px] transition-all duration-300">
              <span className="absolute top-6 right-8 text-6xl font-black text-slate-100 group-hover:text-slate-200 transition-colors">03</span>
              <h3 className="text-xl font-bold mb-4">Full Ownership</h3>
              <p className="text-slate-500 leading-relaxed mb-6">Export directly to high-res PNG, SVG, or take the JSON into Excalidraw for final manual polishes.</p>
      ...
      <footer className="py-24 px-8 text-center bg-[#0a0a0b] text-white">
        ...
        <div className="flex flex-col items-center gap-6">
          ...
          <p className="text-slate-500 text-sm font-mono uppercase tracking-widest">No credit card. No friction. Just draw.</p>
        </div>
